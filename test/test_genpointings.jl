sstr = CMBSim.ScanningStrategy(spinsunang_rad = 0.0,
    borespinang_rad = 0.0,
    spin_rpm = 0.0,
    prec_rpm = 0.0,
    hwp_rpm = 0.0)

dirs = CMBSim.genpointings(sstr, 0.:3600.:86400., Float64[0, 0, 1], 0.0)
...
dirs = CMBSim.genpointings(sstr, 0.:0.1:120., Float64[0, 0, 1], 0.0)
...
dirs = CMBSim.genpointings(sstr, 0.:1.:60., Float64[0, 0, 1], 0.0)
...
sstr = CMBSim.ScanningStrategy(spinsunang_rad = deg2rad(15.),
    borespinang_rad = 0.0,
    spin_rpm = 1.0,
    prec_rpm = 0.0,
    hwp_rpm = 1.0,
